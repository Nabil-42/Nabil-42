...
[![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white)](https://github.com/Nabil-42)
[![Ansible](https://img.shields.io/badge/Ansible-EE0000?style=flat&logo=ansible&logoColor=white)](https://github.com/Nabil-42)
[![Windows Server](https://img.shields.io/badge/Windows_Server-0078D6?style=flat&logo=windows&logoColor=white)](https://github.com/Nabil-42)
...
I am actively looking for a **4-month internship starting September 2026** in **Île-de-France**, in one of the following areas:
...
| **Dev (42 cursus)** | C (systems programming), C++ (modules 1–9) |
...
→ See [PROJECTS.md](PROJECTS.md) for the full list of completed and in-progress projects with grades and links.

---

## Lab & Personal Projects

- **Ansible lab on AWS EC2** — 4 Ubuntu instances (eu-west-3), automated deployment of PrestaShop + MySQL with Ansible roles
- **Windows Server / Active Directory** — domain controller, OU structure, GPO, DHCP/DNS, VLAN segmentation
- **Docker infrastructure** (Inception project) — Nginx + WordPress + MariaDB with custom Dockerfiles, volumes, and secrets

→ See [infra-notes](https://github.com/Nabil-42/infra-notes) for full documentation.
...
> **Open to internship opportunities** — Sysadmin / Network / Security — Île-de-France — September 2026

---

<div align="center">
<sub>École 42 Paris · RNCP37680 AIS · Promo 2024/2025</sub>
</div>
